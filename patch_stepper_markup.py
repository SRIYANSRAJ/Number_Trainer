...
new_additionStepperMarkup = """function additionStepperMarkup(aStr, bStr, base, revealed) {
...
content = re.sub(r'function additionStepperMarkup\(.*?\).*?(?=\nfunction computeExplain)', new_additionStepperMarkup + '\n', content, flags=re.DOTALL)

new_subtractionStepperMarkup = """function subtractionStepperMarkup(aStr, bStr, base, revealed) {
...
content = re.sub(r'function subtractionStepperMarkup\(.*?\).*?(?=\nfunction computeExplain)', new_subtractionStepperMarkup + '\n', content, flags=re.DOTALL)
